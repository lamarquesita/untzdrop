  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4">
        ...
        <motion.div
          className="relative w-full sm:max-w-[400px] bg-[#111111] sm:border border-[#2A2A2A] rounded-t-2xl sm:rounded-none flex flex-col max-h-[90vh] sm:max-h-none overflow-hidden"
        ...
        >
          ...
          {/* Header */}
          <motion.div
            className="flex items-center justify-between px-6 py-4 sm:py-5 border-b border-[#2A2A2A] shrink-0"
          ...
          >
            ...
            {/* Close X — desktop only; mobile uses drag handle */}
            <button
              onClick={onClose}
              className="hidden sm:flex w-8 h-8 items-center justify-center hover:bg-[#2A2A2A] cursor-pointer bg-transparent border-none text-[#888] hover:text-white transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
          </motion.div>
